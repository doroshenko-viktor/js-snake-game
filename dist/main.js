...
exports.GAME_SPEED_MS = exports.SNAKE_INIT_LENGTH = exports.FIELD_HEIGHT = exports.FIELD_WIDTH = exports.APP_ID = void 0;
exports.APP_ID = "app";
exports.FIELD_WIDTH = 40;
exports.FIELD_HEIGHT = 40;
exports.SNAKE_INIT_LENGTH = 10;
exports.GAME_SPEED_MS = 200;


/***/ }),

/***/ "./src/controllers/keyboard-events-controller.ts":
/*!*******************************************************!*\
  !*** ./src/controllers/keyboard-events-controller.ts ***!
  \*******************************************************/
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const snake_1 = __webpack_require__(/*! ../models/snake */ "./src/models/snake.ts");
const keyboardHandlers = new Map();
document.addEventListener("keydown", (event) => {
    keyboardHandlers.forEach(handler => handler(event.key, event.code));
});
const addDirectionKeyPressedEventHandler = (handlerName, handler) => {
    keyboardHandlers.set(handlerName, (key, code) => {
        console.log(`key: ${key}; code: ${code}`);
        if (key === 'ArrowUp') {
            handler(snake_1.SnakeDirection.Up);
        }
        else if (key === 'ArrowDown') {
            handler(snake_1.SnakeDirection.Down);
        }
        else if (key === 'ArrowLeft') {
            handler(snake_1.SnakeDirection.Left);
        }
        else if (key === 'ArrowRight') {
            handler(snake_1.SnakeDirection.Right);
        }
    });
};
exports["default"] = { addDirectionKeyPressedEventHandler };


/***/ }),

/***/ "./src/controllers/ui-controller.ts":
/*!******************************************!*\
  !*** ./src/controllers/ui-controller.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const constants_1 = __webpack_require__(/*! ../configuration/constants */ "./src/configuration/constants.ts");
const getAppElement = () => {
    return document.getElementById(constants_1.APP_ID);
};
const createCell = (gameCell) => {
    const cell = document.createElement('div');
    if (gameCell.occupation === types_1.OccupationType.Snake) {
        cell.classList.add("snake-selected");
    }
    else if (gameCell.occupation === types_1.OccupationType.Target) {
        cell.classList.add("target-selected");
    }
    return cell;
};
const createRow = (gameRow) => {
...
const renderField = (app, gameField) => {
...
exports["default"] = { getAppElement, renderField };
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const ui_controller_1 = __importDefault(__webpack_require__(/*! ./controllers/ui-controller */ "./src/controllers/ui-controller.ts"));
const constants_1 = __webpack_require__(/*! ./configuration/constants */ "./src/configuration/constants.ts");
const field_1 = __webpack_require__(/*! ./models/field */ "./src/models/field.ts");
const snake_1 = __webpack_require__(/*! ./models/snake */ "./src/models/snake.ts");
const keyboard_events_controller_1 = __importDefault(__webpack_require__(/*! ./controllers/keyboard-events-controller */ "./src/controllers/keyboard-events-controller.ts"));
const app = ui_controller_1.default.getAppElement();
const snake = new snake_1.Snake(constants_1.SNAKE_INIT_LENGTH);
const field = new field_1.Field(constants_1.FIELD_WIDTH, constants_1.FIELD_HEIGHT, snake);
keyboard_events_controller_1.default.addDirectionKeyPressedEventHandler('snakeHandler', snake.changeDirection.bind(snake));
run();
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        const x = true;
        while (x) {
            yield delay(constants_1.GAME_SPEED_MS);
            field.makeStep();
            ui_controller_1.default.renderField(app, field);
        }
    });
}
function delay(periodMs) {
    return __awaiter(this, void 0, void 0, function* () {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Field = exports.FieldRow = exports.FieldCell = void 0;
const lodash_1 = __importDefault(__webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js"));
const types_1 = __webpack_require__(/*! ../types */ "./src/types.ts");
class FieldCell {
    constructor() {
        this._occupation = types_1.OccupationType.None;
    }
    get occupation() {
...
class FieldRow {
    constructor(length) {
        this._cells = lodash_1.default.range(0, length).map(() => new FieldCell());
    }
    get cells() {
        return this._cells;
    }
...
class Field {
    ...
    clear() {
        this._rows = lodash_1.default.range(0, this._height).map(() => {
    ...
    projectSnake() {
        this._snake.getCells().forEach(cell => {
            ...
            fieldCell.occupation = types_1.OccupationType.Snake;
        });
    }
}
exports.Field = Field;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Snake = exports.SnakeDirection = void 0;
const lodash_1 = __importDefault(__webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js"));
const linked_list_1 = __webpack_require__(/*! linked-list */ "./node_modules/linked-list/index.js");
var SnakeDirection;
...
class Cell extends linked_list_1.Item {
    constructor(x, y) {
        super();
        this.x = x;
        this.y = y;
...
class Snake {
    constructor(initLength) {
        ...
        const cells = lodash_1.default.range(0, initLength).map((ind) => {
            return new Cell(ind, 0);
        });
        this._body = linked_list_1.List.from(cells);
    }
    ...
    makeStep(cb) {
        ...
        if (this._direction === SnakeDirection.Right && this._body.tail !== null) {
            ...
            if (!isExtendSize) {
                (_a = this._body.head) === null || _a === void 0 ? void 0 : _a.detach();
            }
        }
            ...
            this._body.append(normalizedCell);
            if (!isExtendSize) {
                (_b = this._body.head) === null || _b === void 0 ? void 0 : _b.detach();
            }
        }
            ...
            this._body.append(normalizedCell);
            if (!isExtendSize) {
                (_c = this._body.head) === null || _c === void 0 ? void 0 : _c.detach();
            }
        }
            ...
            this._body.append(normalizedCell);
            if (!isExtendSize) {
                (_d = this._body.head) === null || _d === void 0 ? void 0 : _d.detach();
            }
        }
    }
    getCells() {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.OccupationType = void 0;
var OccupationType;
(function (OccupationType) {
    OccupationType[OccupationType["None"] = 0] = "None";
    OccupationType[OccupationType["Snake"] = 1] = "Snake";
    OccupationType[OccupationType["Target"] = 2] = "Target";
